...
//		if(memid.equals("memid") && memname.equals("")) {
//			
//			model.addAttribute("mlist",dao.mlist(rowStart,rowEnd,searchKeyword,"1"));
//		}else if(memid.equals("") && memname.equals("memname")) {
//			
//			model.addAttribute("mlist",dao.mlist(rowStart,rowEnd,searchKeyword,"2"));
//		}else if(memid.equals("memid") && memname.equals("memname")) {
//			
//			model.addAttribute("mlist",dao.mlist(rowStart,rowEnd,searchKeyword,"3"));
//		}else if(memid.equals("") && memname.equals("")) {
//			
//			model.addAttribute("mlist",dao.mlist(rowStart,rowEnd,searchKeyword,"4"));
//		}
//		
